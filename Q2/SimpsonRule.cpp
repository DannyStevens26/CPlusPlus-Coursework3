...
double SimpsonRule::EstimateError(const double onePanel, const double twoPanel)
{
    // Use Getp, a method just to find the appropriate order of accuracy for each integral for Simpson rule
    double mp = mpIntegral->Getp();
